...
class MultiDatasets(Dataset):
    def __init__(self, opt, transform):
        ...
        batch_filelist = np.array(self.img_list).reshape(-1, batch_size)
        shuffle_batch_filelist = batch_filelist.copy()
        np.random.shuffle(shuffle_batch_filelist)
        self.img_list = shuffle_batch_filelist.reshape(-1)
    ...
    def __getitem__(self, index):
        ...
        # 0:glioma 1:brats 3:ISLES2015 3:ISLES22 4:immune
