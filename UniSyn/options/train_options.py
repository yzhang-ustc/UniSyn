...
class TrainOptions(BaseOptions):
    def initialize(self):
        ...
        self.parser.add_argument('--display_freq', type=int, default=250, help='frequency of showing training results on screen')
...
#        self.parser.add_argument('--no_html', action='store_true', help='do not save intermediate training results to [opt.checkpoints_dir]/[opt.name]/web/')
        ...
        self.parser.add_argument('--lambda_vgg', type=float, default=1.0, help='weight for perceptual loss')
